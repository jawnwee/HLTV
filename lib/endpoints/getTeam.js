...
var getTeam = function (config) {
    return function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var $, _c, name, logoSrc, logo, facebook, twitter, instagram, rank, players, rankingDevelopment, rankings, country, news;
        var _d;
        var id = _b.id;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    players = (_d = $('.players-table tbody tr')
                        .toArray()
                        ...
                        .concat.apply(_d, ($('.coach-table').exists()
                        ? [
                            {
