...
var getMatch = function (config) {
    return function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var $, _c, title, date, format, significance, status, hasScorebot, statsId, team1, team2, vetoes, event, odds, oddsCommunity, maps, players, streams, demos, highlightedPlayers, headToHead, highlights, playerOfTheMatch, winnerTeam;
        var id = _b.id;
