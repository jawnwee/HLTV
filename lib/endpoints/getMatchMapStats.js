...
exports.getMatchMapStats = exports.Outcome = void 0;
...
var getMatchMapStats = function (config) {
    return function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var _c, m$, p$, matchId, halfsString, result, map, date, team1, team2, event, roundHistory, overview, playerStats, performanceOverview;
        var id = _b.id;
