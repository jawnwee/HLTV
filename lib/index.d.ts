...
export declare class Hltv {
    ...
    connectToScorebot: ({ id, onScoreboardUpdate, onLogUpdate, onFullLogUpdate, onConnect, onDisconnect }: {
        id: number;
        onScoreboardUpdate?: (data: import("./endpoints/connectToScorebot").ScoreboardUpdate, done: () => void) => any;
        onLogUpdate?: (data: import("./endpoints/connectToScorebot").LogUpdate, done: () => void) => any;
